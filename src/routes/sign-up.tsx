          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="At least 8 characters" required minLength={8} disabled={isLoading} autoComplete="new-password" className="h-11 border-border bg-background text-body placeholder:text-muted-foreground focus-visible:ring-primary" />
              </div>
